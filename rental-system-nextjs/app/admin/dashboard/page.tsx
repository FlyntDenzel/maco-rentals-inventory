            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <button
                    ...
                    className="p-4 bg-blue-50 hover:bg-blue-100 rounded-lg text-left transition group"
                >
                ...
                <button
                    onClick={() => router.push('/admin/finances')}
                    className="p-4 bg-green-50 hover:bg-green-100 rounded-lg text-left transition group"
                >
                  <div className="text-2xl mb-2 group-hover:scale-110 transition-transform">➕</div>
                ...
                <button
                    onClick={() => router.push('/admin/finances')}
                    className="p-4 bg-purple-50 hover:bg-purple-100 rounded-lg text-left transition group"
                >
                  <div className="text-2xl mb-2 group-hover:scale-110 transition-transform">📊</div>
                ...
                <button
                    onClick={() => alert('Navigate to inventory management to add items')}
                    className="p-4 bg-orange-50 hover:bg-orange-100 rounded-lg text-left transition group"
                >
                  <div className="text-2xl mb-2 group-hover:scale-110 transition-transform">📦</div>
